...
| #*606* | Issue finding features such as find, home, or others features located in the hamburger menu on the main page. Find search format was hard to understand at times. Formatting such as 'sacromento, california' was used which had 0 results becuase of how the match string has been implemented/database contents. The trip's name wasn't clear and was hard to find. Potential solutions for hamburger, we could have popups describing button use cases. The trip name could first be loaded with a default name such as 'Trip name' and some way to make it clear it can be edited. For find we could start with describing the format search in the find search bar.  | med | N/A |
